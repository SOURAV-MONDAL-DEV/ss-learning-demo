            ...
            <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly'>
                        ...
                        <h1 className='text-midnightblue text-4xl sm:text-5xl font-semibold text-center lg:text-start lh-120 pt-5 lg:pt-0'>শেখো আনন্দে, পড়ালেখা নিয়ে থাকো চিন্তামুক্ত !</h1>
                        <h3 className='text-charcoal text-lg font-normal text-center lg:text-start opacity-75 pt-5 lg:pt-0'> দক্ষতা বাড়াও তোমার পড়ালেখায় আমাদের দেশ সেরা শিক্ষকদের হাত ধরে</h3>
