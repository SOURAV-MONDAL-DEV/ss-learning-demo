...
const postData: DataType[] = [
    {
        heading: 'বিজ্ঞান', //বিজ্ঞান,  ৯ম-১০ম শ্রেণি
        heading2: '৯ম-১০ম শ্রেণি',
        name: "Colt stelle",
            ...
            <div id="courses">
                <div className='mx-auto max-w-7xl sm:py-8 px-4 lg:px-8 '>
                    ...
                    <div className="sm:flex justify-between items-center">
                        <h3 className="text-midnightblue text-4xl lg:text-55xl font-semibold mb-5 sm:mb-0">Popular classes.</h3>
                        <Link href={'/'} className="text-Blueviolet text-lg font-medium space-links">Explore classes&nbsp;&gt;&nbsp;</Link>
                    </div>
